...
#
# This fork is hosted on Github and was created by Peter Marklund
#
############################################################
    ...
    module Bitfield #:nodoc:
      ...
      module SingletonMethods
        ...
        def construct_attributes_from_arguments(attribute_names, arguments)
          ...
          attribute_names.each_with_index { |name, idx| conditions << attribute_condition("#{table_name}.#{name}", arguments[idx]) }
